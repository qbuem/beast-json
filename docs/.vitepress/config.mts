...
export default withMermaid(
    defineConfig({
        title: "qbuem-json",
        description: "qbuem-json — Universal JSON Handling Toolkit. The fastest C++20 JSON parser and serializer. Single header, zero dependencies, AVX-512 SIMD accelerated, zero-allocation design for HFT, game engines, and high-throughput servers.",
        base: '/qbuem-json/',
        lang: 'en-US',
        appearance: false,
        ...
        head: [
            ...
            // Open Graph
            ['meta', { property: 'og:title', content: 'qbuem-json - The Fastest C++20 JSON Engine' }],
            ['meta', { property: 'og:description', content: 'qbuem-json is a bleeding-edge C++20 JSON library with AVX-512 SIMD acceleration, zero-allocation design, and single-header simplicity. Up to 2.7 GB/s parsing, 8.1 GB/s serialization.' }],
            ...
            ['meta', { name: 'twitter:title', content: 'qbuem-json - The Fastest C++20 JSON Engine' }],
        ...
        themeConfig: {
            ...
            footer: {
                ...
                copyright: 'Copyright © 2026 qbuem-json Authors'
            }
        },
        mermaid: {
