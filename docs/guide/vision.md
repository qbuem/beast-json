...
- [x] Zero-Allocation Tape DOM.
- [x] AVX-512 & ARM NEON structural indexing.
- [x] Russ Cox unrounded scaling for numbers.
- [x] C++20 Concepts-based API.

### Phase 2: Compliance & Reliability (Complete)
- [x] Strict RFC 6901 (JSON Pointer) compliance.
